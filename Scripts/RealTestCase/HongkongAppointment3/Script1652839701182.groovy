...
WebUI.click(findTestObject('CreateAppointment/Page_CURA Healthcare Service/label_None'))
...
WebUI.setText(findTestObject('CreateAppointment/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Test Hongkong Appointment - None')
