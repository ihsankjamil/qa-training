...
WebUI.setText(findTestObject('CreateAppointment/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Test Tokyo Appointment - Medicare')
...
WebUI.verifyTextPresent(GlobalVariable.TOKYO, false)
