...
WebUI.click(findTestObject('CreateAppointment/Page_CURA Healthcare Service/label_Medicaid'))
...
WebUI.setText(findTestObject('CreateAppointment/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Test Hongkong Appointment - Medicaid')
